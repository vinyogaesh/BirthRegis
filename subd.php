...
<h1 align="center"><font color="#000000" size="5">ONLINE BIRTH AND DEATH REGISTRATION PORTAL</font></h1>
        ...
        <div id="menu">
            <ul>                                        
                ...
                <li><a class="current" href="deathentry.php" title="">Death Entry</a></li>
    ...
    <div class="green_box">
        ...
        <div class="read_more"><a href="documents\Death certificate.docx" TARGET="_blank" >read more</a></div>
        </div>
    ...
    <div id="main_content">
      ...
      <form action="dstor.php" method="post">
<table border="0" align="center">
<tr><td>Select District</td><td>:</td><td><input type="text" name="dist" value="<?php echo $_POST['dist'];?>" size="10" /><a href="deathentry.php"><img src="images\refresh.png" width="20" /></a>
</td></tr>

<tr><td>Select Zone</td><td>:</td><td><select name="zone">
<?php
$pname=$_POST['dist'];
...
<tr><td>Enter Name</td><td>:&nbsp;</td><td><input type="text" name="name"  /></td></tr>
...
<tr><td>Enter Date Of Death</td><td>:&nbsp;</td><td><input id='bday' class='datepicker' name="bday"></td></tr>
<tr><td>Place Of Death</td><td>:&nbsp;</td><td><input type="text" name="placedeath"></td></tr>
...
<tr><td>Address At Time Of Death</td><td>:&nbsp;</td><td><textarea name="aaddress"></textarea></td></tr>
...
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Store" /></td><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="clear" value="Clear All" /></td></tr>
        ...
        <h2>Hints To Register</h2>
            ...
            <p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Enter Name</p>
            <p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Select Sex Type</p>
            <p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Select Date of Death</p>
            <p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Enter Place of Death</p>
<p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Enter Father and Mother name</p>
<p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Enter Permenant Address</p>
<p><font color="#FF0000">*</font>&nbsp;&nbsp;&nbsp;&nbsp;Enter Address time of Death</p>
