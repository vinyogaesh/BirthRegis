...
{
	 // Logo
    $this->Image('llogo.png',10,6,20);
    // Arial bold 15
    //$this->SetFont('Arial','B',15);
    // Move to the right
	$this->Image('mlogo.png',90,6,10);
    $this->SetFont('times','I',8);
    // Print centered page number
    //$this->Cell(0,10,' TAMILNADU GOVERMENT',0,0,'C');
	
	
	//$this->Cell(80);
    // Title
	$this->Image('rlogo.png',170,6,20);
...
function Footer()
{
    ...
    $this->SetFont('times','I',8);
    // Print centered page number
    $this->Cell(0,10,' © 2012 Developed by Vinoth K S , MCA .,',0,0,'C');
}
