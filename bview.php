...
<h1 align="center"><font color="#000000" size="5">ONLINE BIRTH AND DEATH REGISTRATION PORTAL</font></h1>
        ...
        <div id="menu">
            <ul>                                        
                ...
                <li><a class="current" href="birthview.php" title="">Birth Certificate View</a></li>
    ...
    <div class="green_box">
        ...
        <div id="right_nav">
            <ul>                                        
                ...
                <li><a  href="bentry.php" title="">Birth Entry</a></li>
                <li><a href="deathentry.php" title="">Death Entry</a></li>
                <li><a  class="current" href="birthview.php" title="">Birth View</a></li>
...
$result = mysql_query("SELECT * FROM birth_reg WHERE districit='$na'"); 
