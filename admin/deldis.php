...
<tr><td><input type="submit" name="s" value="Delete Dist"  /></td></tr>
    	...
    	<div id="right_content">
            ...
            <form action="seldist.php" method="post">
   <table border="0" align="center">

<tr><td>Select District Name:-</td><td>:</td><td><select name="dist"><option value="">-------Select------</option><?php
//$place=$_SESSION['place'];
//echo $place; 
$bnm="select distric from distr ORDER BY id";
$ansv=mysql_query($bnm);
   while($rowa=mysql_fetch_array($ansv))
   {?> <option value="<?php echo $rowa['distric'];?>"> <?php echo $rowa['distric']; } ?></option></select><br /><br /></td><td><input type="submit" name="subm" value="Retrive Zone" /></td></tr>
</table>
</form>
            </p>
            <br />
