...
{
var x=document.forms["sub"]["dist"].value;
...
<h1 align="center"><font color="#000000" size="5">ONLINE BIRTH AND DEATH REGISTRATION PORTAL</font></h1>
    ...
    <div id="main_content">
      ...
      <form action="subd.php" method="post" name="sub" onsubmit="return validateForm()" >
<table border="0" align="center">

<tr><td>Select District</td><td>:</td><td><select name="dist" ><option value="">--Select--</option><?php
//$place=$_SESSION['place'];
//echo $place;
$bnm="select distric from distr ORDER BY id ";
$ansv=mysql_query($bnm);
   while($rowa=mysql_fetch_array($ansv))
   {?><option value="<?php echo $rowa['distric'];?>"> <?php echo $rowa['distric']; } ?></option></select></td><td><input type="submit" name="submit" value="Retrive Zone" /></td></tr>
</table>
</form>  
